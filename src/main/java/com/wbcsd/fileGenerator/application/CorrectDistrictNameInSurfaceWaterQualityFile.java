 ...
 * @author Aashish
 */
public class CorrectDistrictNameInSurfaceWaterQualityFile {
    ...
    public static void main(String[] args) {
        ...
        List<String[]> originallyPopulatedData = dataReader
                .readFileData("E:\\EclipseWorkspace\\fileGenerator\\src\\main\\resources\\Output\\SiteInfo\\SurfaceWaterQuality.csv");
