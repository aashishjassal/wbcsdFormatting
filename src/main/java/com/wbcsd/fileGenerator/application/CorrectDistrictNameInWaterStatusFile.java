 ...
 * @author Aashish
 */
public class CorrectDistrictNameInWaterStatusFile {
    ...
    public static void main(String[] args) {
        ...
        List<String[]> originallyPopulatedData = dataReader
                .readFileData("E:\\EclipseWorkspace\\fileGenerator\\src\\main\\resources\\Output\\SiteInfo\\WaterStatus_2007-2011.csv");
                ...
                for (int r = 0; r < dataRow.length; r++) {
                    if (r == 3) {
                        ...
                        String finalDistrict = DistrictMapper.getOverriddenNameIfApplicable(rowState, rowDistrict,
                                masterDistricts);
                        if (StringUtils.equals(rowDistrict, "ANANTAPUR")) {
