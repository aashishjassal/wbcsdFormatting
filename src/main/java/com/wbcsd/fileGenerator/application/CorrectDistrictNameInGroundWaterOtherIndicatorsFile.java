 ...
 * @author Aashish
 */
public class CorrectDistrictNameInGroundWaterOtherIndicatorsFile {
    ...
    public static void main(String[] args) {
        ...
        List<String[]> originallyPopulatedData = dataReader
                .readFileData("E:\\EclipseWorkspace\\fileGenerator\\src\\main\\resources\\Output\\SiteInfo\\GroundWaterOtherIndicators-2011.csv");
