            ...
            if (StringUtils.equalsIgnoreCase(mapKeyState, stateName)) {
                if (StringUtils.equalsIgnoreCase(mapKeyDistrict, districtName)) {
                    if (StringUtils.equalsIgnoreCase(mapKeyBlock, blockName)) {
                        ...
                        // Cases like, Sarkarsammakulam in block file and Sarkar Sammakulam in siteInfo file, return
                        // site info name
                        return StringUtils.capitalize(mapKeyBlock);
                    } else if (StringUtils.endsWithIgnoreCase(mapKeyBlock, "North")) {
                        // Cases like, POLLACHI(N) in block file and POLLACHI NORTH in siteInfo file, return site info
                        // name.
                        ...
                        // Cases like, POLLACHI(S) in block file and POLLACHI SOUTH in siteInfo file, return site info
                        // name.
                        ...
                        if (StringUtils.equalsIgnoreCase(StringUtils.remove(blockName, "_W"), tempSiteInfoName)
                            ...
                            StringUtils.remove(mapKeyBlock, " "))) {
                        // Cases like, Boath(NC) in block file and Boath in siteInfo file, return site info name.
                        return StringUtils.capitalize(mapKeyBlock);
                    } else if (StringUtils.containsIgnoreCase(blockName, DOT)) {
                        // Cases like, B.K. Samudram in block file and BUKKARAYASAMUDRAM in siteInfo file.
